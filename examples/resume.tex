...
\address{314 Goyder St, Narrabundah, ACT 2604, Australia}

\mobile{(+61) 491-181-822}
\email{jianqi.zhao.xian@gmail.com}
%\dateofbirth{January 1st, 1970}
%\homepage{www.posquit0.com}
\github{https://github.com/jianqibot}
%\linkedin{posquit0}
% \gitlab{gitlab-id}
...
\quote{``Write programs that do one thing and do it well."}
